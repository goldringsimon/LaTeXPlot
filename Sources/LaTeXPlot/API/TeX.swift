...
public struct TeX: DocumentFormat {
	private let document: Document<TeX>
	private var environmentOverrides = [Environment.Override]()

	public init(_ nodes: Node<TeX.DocumentContext>...) {
...
//	init(head: [Node<TeX.HeadContext>] = [],
...
//	}
	...
	func environmentValue<T>(_ value: T, key: EnvironmentKey<T>) -> TeX {
		var html = self
